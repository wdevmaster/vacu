...
INSERT INTO `negocio` VALUES (1,'Mi negocio','Jorge','78787713',1);
...
--
-- Table structure for table `usuario_has_permiso`
--
...
CREATE TABLE `usuario_has_permiso` (
  ...
  KEY `fk_usuario_has_permiso_permiso1_idx` (`permiso_idpermiso`),
  KEY `fk_usuario_has_permiso_usuario1_idx` (`usuario_idusuario`),
  CONSTRAINT `fk_usuario_has_permiso_permiso1` FOREIGN KEY (`permiso_idpermiso`) REFERENCES `permiso` (`idpermiso`),
  CONSTRAINT `fk_usuario_has_permiso_usuario1` FOREIGN KEY (`usuario_idusuario`) REFERENCES `usuario` (`idusuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `usuario_has_permiso`
--

LOCK TABLES `usuario_has_permiso` WRITE;
/*!40000 ALTER TABLE `usuario_has_permiso` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuario_has_permiso` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-02-14 11:02:30
